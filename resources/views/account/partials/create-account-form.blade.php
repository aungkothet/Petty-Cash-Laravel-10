<section>
    ...
    <form method="post" action="{{ route('account.store') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="credit" :value="__('Opening Balance')" />
            <x-text-input id="credit" name="credit" type="number"  step="any" min="0.00" class="mt-1 block w-full rounded-md "  :value="old('credit')" required />
